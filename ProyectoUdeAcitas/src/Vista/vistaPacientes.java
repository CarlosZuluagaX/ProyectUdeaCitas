...
//    }
    ...
    String[] getColumnas(){ //Columnas
        columna = new String[] {"IDPACIENTE","NOMBRE","APELLIDOPAT","APELLIDOMAT","IDENTI","IDUNIDADMEDICA"};
        //{"DNI","USUARIOS","NOMBRES","APELLIDOS","GRUPO","MONTOSOLICITADO","SOL","CALIFICACION","FECHASOLICITUD","STATUS"};
        return columna;
    }
    
    //ACA YA ES EXPLICACIÓN DEL CODIGO EN SQL, EN LENGUAJE DE MY SQL QUE LA CONECTAMOS A BASE DE DATOS 
    //LOCAL, QUE USAMOS XAMPP 
    void setFilas(){
        try{
            String Sql = "";
